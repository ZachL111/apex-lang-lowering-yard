...
apex-lang-lowering-yard is a Julia project for compilers. It focuses on this technical goal: Create a Julia reference implementation for lowering workflows, centered on incremental indexing, append-only fixtures, and checkpoint recovery checks.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 152, risk penalty 7, latency penalty 2, and weight bonus 6. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
