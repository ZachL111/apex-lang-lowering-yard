"""Regression checks for the apex-lang-lowering-yard casebook."""
...
from casebook.harness import assert_expected, apex_lang_lowering_yard_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(apex_lang_lowering_yard_summary(), assert_expected())
